...
interface TimelineContentProps {
  ...
  scrollRef?: React.RefObject<HTMLDivElement>; // Optional ref for scroll syncing
  allTracksScrollRef?: React.RefObject<HTMLDivElement>;
  videoTracksScrollRef?: React.RefObject<HTMLDivElement>;
  audioTracksScrollRef?: React.RefObject<HTMLDivElement>;
