...
本目录是商媒运营助手的 React renderer，实现页面、组件、bridge 消费和运行时事件 UI。

## Entry Points

- [main.tsx](/Volumes/macsoftware/codes/agentscompany/yunyingagent/src/desktop/src/main.tsx)
- [App.tsx](/Volumes/macsoftware/codes/agentscompany/yunyingagent/src/desktop/src/App.tsx)
